...
window.Mercadopago.setPublishableKey("TEST-46d5efdf-4d23-4dd5-99e0-893ac3a7f09b");
...
document.getElementById('product-description').addEventListener('change', function(){
    document.getElementById('description').value = document.getElementById('product-description').value;
});
